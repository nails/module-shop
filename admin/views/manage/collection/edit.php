<div class="group-shop manage collections edit">
	...
	<ul class="tabs disabled">
		<li class="tab">
			<?=anchor( 'admin/shop/manage/collection' . $isFancybox, 'Overview', 'class="confirm" data-title="Are you sure?" data-body="Any unsaved changes will be lost."' )?>
		</li>
		<li class="tab active">
	...
	<section class="tabs pages">
		<div class="tab page active">
			...
			<p style="margin-top:1em;">
				...
				<?=anchor( 'admin/shop/manage/collection' . $isFancybox, 'Cancel', 'class="awesome red confirm" data-title="Are you sure?" data-body="All unsaved changes will be lost."' )?>
			</p>
		</div>
	</section>
	<?=form_close();?>
