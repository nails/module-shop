<div class="group-shop manage brands edit">
	...
	<ul class="tabs disabled">
		<li class="tab">
			<?=anchor( 'admin/shop/manage/brand' . $isFancybox, 'Overview', 'class="confirm" data-title="Are you sure?" data-body="Any unsaved changes will be lost."' )?>
		</li>
		<li class="tab active">
		...
		<div class="tab page active">
			<fieldset>
				...
				<?php
					...
					$_field['default']		= isset( $brand->cover_id ) ? $brand->cover_id : '';
					$_field['bucket']		= 'shop-brand-cover';
			...
			<p style="margin-top:1em;">
				...
				<?=anchor( 'admin/shop/manage/brand' . $isFancybox, 'Cancel', 'class="awesome red confirm" data-title="Are you sure?" data-body="All unsaved changes will be lost."' )?>
			</p>
		</div>
	</section>
	<?=form_close();?>
