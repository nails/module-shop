<div class="group-shop manage ranges edit">
	...
	<ul class="tabs disabled">
		<li class="tab">
			<?=anchor( 'admin/shop/manage/range' . $isFancybox, 'Overview', 'class="confirm" data-title="Are you sure?" data-body="Any unsaved changes will be lost."' )?>
		</li>
		<li class="tab active">
		...
		<div class="tab page active">
			<fieldset>
				...
				<?php
					...
					$_field['default']		= isset( $range->cover_id ) ? $range->cover_id : '';
					$_field['bucket']		= 'shop-range-cover';
			...
			<p style="margin-top:1em;">
				...
				<?=anchor( 'admin/shop/manage/range' . $isFancybox, 'Cancel', 'class="awesome red confirm" data-title="Are you sure?" data-body="All unsaved changes will be lost."' )?>
			</p>
		</div>
	</section>
	<?=form_close();?>
