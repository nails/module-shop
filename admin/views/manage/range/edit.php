<div class="group-shop manage ranges edit">
    ...
    ?>
    <p class="<?=$class?>">
        Manage which ranges are available for your products. Products grouped together into
        a range are deemed related and can have their own customised landing page.
    </p>
    <?=$isFancybox ? '' : '<hr />'?>
    ...
    <section class="tabs pages">
        <div class="tab page active">
            ...
            <?php
                ...
                echo anchor(
                    'admin/shop/manage/range' . $isFancybox,
                    'Cancel',
