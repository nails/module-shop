...
class Reports extends BaseAdmin
{
    ...
    protected function sourceOrders($period)
    {
        ...
        $select = array(
            ...
            'o.base_currency',
            'o.total_base_item',
            'o.total_base_item_discount',
            'o.total_base_shipping',
            'o.total_base_shipping_discount',
            'o.total_base_tax_item',
            'o.total_base_tax_item_discount',
            'o.total_base_tax_shipping',
            'o.total_base_tax_shipping_discount',
            'o.total_base_tax_combined',
            'o.total_base_tax_combined_discount',
            'o.total_base_grand',
            'o.total_base_grand_discount',
            'o.total_user_item',
            'o.total_user_item_discount',
            'o.total_user_shipping',
            'o.total_user_shipping_discount',
            'o.total_user_tax_item',
            'o.total_user_tax_item_discount',
            'o.total_user_tax_shipping',
            'o.total_user_tax_shipping_discount',
            'o.total_user_tax_combined',
            'o.total_user_tax_combined_discount',
            'o.total_user_grand',
            'o.total_user_grand_discount',
            'o.shipping_line_1',
            'o.shipping_line_2',
            'o.shipping_town',
            'o.shipping_state',
